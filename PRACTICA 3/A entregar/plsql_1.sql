...
cliente y muestre por pantalla sus datos personales, junto con un listado con los datos de los 
pedidos que ha realizado (código de pedido, fecha, fecha de entrega, estado e importe del pedido),
ordenados crecientemente por fecha. En caso de error (DNI no existe, no hay pedidos para ese
cliente, etc..), deberá mostrarse por pantalla un mensaje de advertencia explicando el error. 
